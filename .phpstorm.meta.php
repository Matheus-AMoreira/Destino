...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\auth()->user(), map([
        '' => \App\Models\Identidade\Usuario::class,
    ]));
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/matheus/WorkSpace/GitHub/Meu/Destino/Laravel/main/public/storage' => 'string',
            ...
            'hashing.argon2id.memory' => 'integer',
            'hashing.argon2id.threads' => 'integer',
            'hashing.argon2id.time' => 'integer',
            'hashing.argon2id.verify' => 'boolean',
...
'view.compiled','activitylog.enabled','activitylog.clean_after_days','activitylog.default_log_name','activitylog.default_auth_driver',
...
'activitylog.actions.clean_log','app.name','app.env','app.debug','app.url',
...
'filesystems.disks.s3.report','filesystems.links./home/matheus/WorkSpace/GitHub/Meu/Destino/Laravel/main/public/storage','hashing.driver','hashing.bcrypt.rounds','hashing.bcrypt.verify',
'hashing.bcrypt.limit','hashing.argon.memory','hashing.argon.threads','hashing.argon.time','hashing.argon.verify',
'hashing.rehash_on_login','hashing.argon2id.memory','hashing.argon2id.threads','hashing.argon2id.time','hashing.argon2id.verify',
...
'ide-helper.post_migrate','inertia.ssr.enabled','inertia.ssr.url','inertia.ssr.bundle','inertia.pages.paths',
...
'session.same_site','session.partitioned','session.serialization','structure-discoverer.ignored_files','structure-discoverer.structure_scout_directories',
...
'signed','throttle','verified','authorize.api','authorize.ui',);
        registerArgumentsSet('routes', 'home','contato','buscar','pacote.detalhes','cadastro','entrar','login',
'password.request','password.email','password.reset','password.update','verification.notice',
'verification.verify','verification.send','logout','checkout','checkout.process',
'user.profile.edit','user.profile.update','user.profile.password','usuario.viagem.detalhes','usuario.viagem.avaliar',
'usuario.viagem.salvar_avaliacao','usuario.viagem.listar','administracao.dashboard','administracao.dashboard.estatisticas','administracao.hotel.index','administracao.hotel.create',
'administracao.hotel.store','administracao.hotel.edit','administracao.hotel.update','administracao.hotel.destroy','administracao.transporte.index',
'administracao.transporte.create','administracao.transporte.store','administracao.transporte.edit','administracao.transporte.update','administracao.transporte.destroy',
'administracao.pacote-foto.index','administracao.pacote-foto.create','administracao.pacote-foto.store','administracao.pacote-foto.edit','administracao.pacote-foto.update',
'administracao.pacote-foto.destroy','administracao.pacote.index','administracao.pacote.create','administracao.pacote.store','administracao.pacote.edit',
'administracao.pacote.update','administracao.pacote.destroy','administracao.pacote.compras','administracao.oferta.index','administracao.oferta.create',
'administracao.oferta.store','administracao.oferta.edit','administracao.oferta.update','administracao.oferta.destroy','administracao.usuario.index',
'administracao.usuario.create','administracao.usuario.store','administracao.usuario.edit','administracao.usuario.update','administracao.usuario.update-status',
'administracao.usuario.destroy','storage.local','storage.local.upload',);
...
'INERTIA_SSR_ENABLED','INERTIA_SSR_URL','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE',
'APP_MAINTENANCE_DRIVER','BCRYPT_ROUNDS','HASH_DRIVER','LOG_CHANNEL','LOG_STACK',
'LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL','DB_CONNECTION','DB_URL','SESSION_DRIVER',
