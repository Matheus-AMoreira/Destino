...
import {
    usePacoteFotoForm,
    type PhotoItem,
} from '@/services/catalogo/pacoteFotoService';
...
export default function Create({ isUploadAvailable }: Props) {
    ...
    const inputClasses =
        'mt-1 block w-full rounded-lg border border-gray-300 px-4 py-2 text-gray-900 shadow-sm transition-all focus:border-purple-500 focus:ring-2 focus:ring-purple-500 outline-none';
    const labelClasses =
            ...
            <div className="mx-auto max-w-4xl">
                {!isUploadAvailable && (
                    <div className="mb-6 rounded-xl bg-red-50 p-4 text-sm text-red-600 border border-red-100">
                        ...
                        <p>
                            O serviço de upload de imagens não está disponível
                            no servidor. Use apenas links (URL).
                        </p>
                    </div>
                )}
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="space-y-4">
                                ...
                                {data.is_url_capa ? (
                                    ...
                                    >
                                        <Upload
                                            size={32}
                                            className="text-gray-400 mb-2 group-hover:text-purple-500 transition-colors"
                                        />
                                ...
                                {(errors.foto_capa_file ||
                                    errors.foto_capa_url) && (
                                    <p className="mt-1 text-xs text-red-500">
                                        {errors.foto_capa_file ||
                                            errors.foto_capa_url}
                                    </p>
                            ...
                            <div className="flex flex-col items-center justify-center">
                                <label
                                    className={`${labelClasses} mb-2 self-start`}
                                >
                                    Prévia da Capa
                                </label>
                    ...
                    <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm">
                        ...
                        <div className="space-y-4">
                            {data.itens.map((item, index) => (
                                <div
                                    key={index}
                                    className="group flex items-start gap-4 rounded-xl border border-gray-100 p-4 transition-all hover:bg-gray-50"
                                >
                                    ...
                                    <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div className="relative">
                                            ...
                                            {/* Display validation errors for items */}
                                            {(errors[`itens.${index}.file`] ||
                                                errors[
                                                    `itens.${index}.url`
                                                ]) && (
                                                <p className="mt-1 text-xs text-red-500">
                            ...
                            {data.itens.length === 0 && (
                                <div className="py-12 text-center border-2 border-dashed border-gray-100 rounded-xl">
                                    <p className="text-sm text-gray-400">
                                        Nenhuma foto auxiliar adicionada.
                                    </p>
                                    <button
                                        type="button"
                                        onClick={addAuxiliaryPhoto}
                    ...
                    <div className="flex items-center justify-end gap-3 border-t border-gray-100 pt-6">
                        ...
                        >
                            <Save size={20} />
                            <span>
                                {processing ? 'Salvando...' : 'Criar Álbum'}
                            </span>
                        </button>
                    </div>
                </form>
