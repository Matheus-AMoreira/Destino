...
import { useUsuarioRegistrar } from '@/services/identidade/usuarioService';
...
export default function Registrar({ roles }: Props) {
    const { form, modal, setModal, zodErrors, handleSubmit } =
        useUsuarioRegistrar(roles[0]?.id || '');
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                        ...
                        <div className="p-6">
                                ...
                                {roles.map((role) => (
                                    ...
                                    >
                                        <div className="flex items-center justify-between mb-2">
                                            <span
                                                className={`font-bold text-sm ${Number(data.role_id) === role.id ? 'text-blue-700' : 'text-gray-700'}`}
                                            >
                                                {role.name}
                                            </span>
                                            <input
                            ...
                            {(zodErrors.role_id || errors.role_id) && (
