                ...
                <div className="space-y-10">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-4xl font-black text-gray-900 tracking-tight">Detalhes do Usuário</h1>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                        {/* Sidebar */}                        <div className="lg:col-span-3 space-y-6">
                        ...
                        <div className="lg:col-span-9">
                                ...
                                <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4">
                                    <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-2xl shadow-blue-100/50 p-10">
                                        <div className="flex items-center justify-between mb-10">
                                            <div>
                                                <h3 className="text-2xl font-black text-gray-900 tracking-tight">Histórico de Reservas</h3>
                                                <p className="text-gray-500 font-medium text-sm">Acompanhe as viagens realizadas pelo usuário.</p>
                                            </div>
                                        ...
                                        <div className="space-y-6">
                                            {compras.length > 0 ? (
                                                compras.filter(c => statusFilter === 'TODOS' || c.status === statusFilter).map(compra => (
                                                    <div key={compra.id} className="p-6 bg-gray-50/50 border border-transparent rounded-3xl hover:border-blue-100 hover:bg-white hover:shadow-xl hover:shadow-blue-50 transition-all group">
                                                        <div className="flex items-center justify-between">
                                                            <div className="flex items-center gap-6">
                                                                ...
                                                                <div>
                                                                    <p className="font-black text-gray-900 text-lg tracking-tight">{compra.oferta.pacote.nome}</p>
                                                                    <p className="text-sm text-gray-500 font-bold">{compra.oferta.hotel.cidade.nome} • {formatDate(compra.data_compra)}</p>
                                                                </div>
                                                            </div>
                                                            <div className="flex items-center gap-6">
                            ...
                            {activeTab === 'perfil' && (
                                <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-2xl shadow-blue-100/50 overflow-hidden animate-in fade-in slide-in-from-bottom-4">
                                    <div className="bg-gray-50/50 px-10 py-8 border-b border-gray-100">
                                        <h3 className="text-2xl font-black text-gray-900 tracking-tight">Dados Pessoais</h3>
                                        <p className="text-gray-500 font-medium text-sm">Atualize as informações de identificação do usuário.</p>
                                    </div>
                                    <form onSubmit={handleUpdatePerfil} className="p-10 space-y-10">
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                            <div className="space-y-2">
                                                ...
                                                />
                                                {(zodErrors.nome || perfilForm.errors.nome) && <p className="text-red-500 text-xs font-bold ml-4">{zodErrors.nome || perfilForm.errors.nome}</p>}
                                            </div>
                                            <div className="space-y-2">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full px-6 py-4 bg-gray-50 border-2 border-transparent rounded-2xl focus:bg-white focus:border-blue-600 focus:ring-4 focus:ring-blue-100 transition-all font-bold text-gray-900 text-lg"
                                                />
                                                {(zodErrors.sobre_nome || perfilForm.errors.sobre_nome) && <p className="text-red-500 text-xs font-bold ml-4">{zodErrors.sobre_nome || perfilForm.errors.sobre_nome}</p>}
                                            </div>
                                        </div>
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                            <div className="space-y-2">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full px-6 py-4 bg-gray-50 border-2 border-transparent rounded-2xl focus:bg-white focus:border-blue-600 focus:ring-4 focus:ring-blue-100 transition-all font-bold text-gray-900 text-lg"
                                                />
                                                {(zodErrors.email || perfilForm.errors.email) && <p className="text-red-500 text-xs font-bold ml-4">{zodErrors.email || perfilForm.errors.email}</p>}
                                            </div>
                                            <div className="space-y-2">
                                                <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-4 flex items-center gap-2">
                                                    <CreditCard size={14} />
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <input
                                                ...
                                                className="w-full px-6 py-4 bg-gray-50 border-2 border-transparent rounded-2xl focus:bg-white focus:border-blue-600 focus:ring-4 focus:ring-blue-100 transition-all font-bold text-gray-900 text-lg"
                                            />
                                            {(zodErrors.telefone || perfilForm.errors.telefone) && <p className="text-red-500 text-xs font-bold ml-4">{zodErrors.telefone || perfilForm.errors.telefone}</p>}
                                        </div>
                            ...
                            {activeTab === 'acesso' && (
                                <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-2xl shadow-blue-100/50 overflow-hidden animate-in fade-in slide-in-from-bottom-4">
                                    <div className="bg-gray-50/50 px-10 py-8 border-b border-gray-100">
                                        <h3 className="text-2xl font-black text-gray-900 tracking-tight">Controle de Acesso</h3>
                                    ...
                                    <form onSubmit={handleUpdateAccess} className="p-10 space-y-12">
                                                ...
                                                {roles.filter(r => r.is_staff === usuario.role?.is_staff).map(role => (
                                                    ...
                                                    >
                                                        <div className="flex items-center justify-between mb-2">
                                                            <span className="font-black text-lg text-gray-900">{role.name}</span>
                                                            <input
                                                                type="radio"
                                                                value={role.id}
                                                        ...
                                                        <p className="text-xs text-gray-500 font-bold leading-relaxed">{role.description}</p>
                                                    </label>
                                                ))}
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex justify-end pt-4">
                                            <button
                                                ...
                                                className="bg-blue-600 text-white px-12 py-4 rounded-2xl font-black uppercase tracking-widest shadow-xl shadow-blue-100 hover:bg-blue-700 transition-all disabled:opacity-50 disabled:scale-95"
                                            >
                                                {acessoForm.processing ? 'Sincronizando...' : 'Atualizar Acessos'}
                                            </button>
                                        </div>
                                    </form>
                                </div>
