        ...
        <AdminLayout title="Dashboard">
            <div className="mb-8">
                ...
                <p className="text-gray-500 mt-1">
                    Bem-vindo ao painel de gerenciamento do Destino.
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
                {cards.map((card) => (
                    <div
                        key={card.label}
                        className="group relative overflow-hidden rounded-2xl bg-white p-6 shadow-sm border border-gray-100 transition-all hover:shadow-md"
                    >
                        <div
                            className={`inline-flex rounded-xl ${card.bg} p-3 ${card.color} mb-4`}
                        >
                            <card.icon size={24} />
                        </div>
                        <div>
            ...
            <div className="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-2">
                ...
                <div className="rounded-2xl bg-white p-8 shadow-sm border border-gray-100 flex flex-col items-center justify-center text-center">
                    ...
                    <p className="mt-2 text-gray-500">
                        Visualize métricas avançadas e tendências de vendas em
                        breve.
                    </p>
                    <Link
                        href={estatisticas().url}
