...
import { useOfertaForm } from '@/services/comercial/ofertaService';
...
export default function Create({
    ...
    const { data, setData, processing, errors, handleSubmit } = useOfertaForm();
        ...
        <AdminLayout title="Nova Oferta">
            <div className="mx-auto max-w-4xl">
                ...
                <form
                    ...
                    className="space-y-8 rounded-2xl bg-white p-8 shadow-sm border border-gray-100"
                >
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                onChange={(e) =>
                                    setData('pacote_id', e.target.value)
                                }
                        ...
                        <div>
                            ...
                            <select
                                ...
                                onChange={(e) =>
                                    setData('transporte_id', e.target.value)
                                }
                                className={inputClasses}
                            >
                                <option value="">Selecione...</option>
                    ...
                    <div className="flex items-center justify-end gap-3 border-t border-gray-100 pt-6">
                        ...
                        >
                            <Save size={20} />
                            <span>
                                {processing ? 'Salvando...' : 'Salvar Oferta'}
                            </span>
                        </button>
                    </div>
                </form>
